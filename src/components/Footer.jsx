...
export default function Footer() {
  return (
    <div className=" text-center text-white container mx-auto pt-32">
      <h2 className="lg:text-5xl text-3xl lg:w-1/2 mx-auto pb-10 font-bold bg-gradient-to-r from-fuchsia-400 via-fuchsia-300 to-yellow-600 bg-clip-text text-transparent">
